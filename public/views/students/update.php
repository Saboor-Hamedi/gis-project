...
<div class="table__card">
  ...
  <div class="row">
    <div class="col-md-12">
      <form action="<?php url('/students/edit'); ?>" method="POST">
        <?php CSRF::generate(); ?>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="title" id="title" value="<?php echo $post[0]['title'] ?? ''; ?>"
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" name="content" id="content"
            rows="3"><?php echo $post[0]['content'] ?? ''; ?></textarea>
